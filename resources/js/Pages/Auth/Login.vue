...
<template>
    ...
    <AuthLayout
        ...
        <div v-if="isAdminLogin" class="mb-6 p-4 rounded-2xl bg-gradient-to-r from-amber-50 to-orange-50 border border-amber-200">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-sm font-bold text-amber-900">Administrator Access</p>
                    <p class="text-xs text-amber-600">Authorized personnel only</p>
                </div>
            </div>
        </div>
