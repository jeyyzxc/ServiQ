...
<template>
    ...
    <AuthLayout title="Create your account" subtitle="Join ServiQ to start managing your support tickets">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input
                        ...
                        autofocus
                        autocomplete="name"
                        class="block w-full pl-12 pr-4 py-3.5 bg-white border border-slate-200 rounded-xl text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all"
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input
                        ...
                        class="block w-full pl-12 pr-12 py-3.5 bg-white border border-slate-200 rounded-xl text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all"
