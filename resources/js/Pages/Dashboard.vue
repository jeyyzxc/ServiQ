            ...
            <div class="grid grid-cols-1 xl:grid-cols-3 gap-6">
                ...
                <div class="bg-white rounded-3xl shadow-xl shadow-slate-200/50 border border-slate-100 overflow-hidden">
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <Link :href="route('profile.edit')" class="group flex items-center p-5 rounded-2xl border-2 border-slate-100 hover:border-slate-200 hover:bg-slate-50/50 transition-all">
                            <div class="w-12 h-12 rounded-xl bg-slate-100 flex items-center justify-center mr-4 group-hover:bg-slate-200 transition-colors">
                            ...
                            <div class="flex-1">
                                <p class="font-bold text-slate-900">Settings</p>
                                <p class="text-sm text-slate-500">Manage your profile</p>
                            </div>
                            <svg class="w-5 h-5 text-slate-300 group-hover:text-slate-500 group-hover:translate-x-1 transition-all" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                            </svg>
                        </Link>
                    </div>
